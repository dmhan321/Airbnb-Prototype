...
2.  [Backend Setup](#backend-setup)
    ...
    * [Team Workflow with Sequelize](#team-workflow-with-sequelize)
    * [Keeping Databases in Sync](#keeping-databases-in-sync)
3.  [Frontend Setup](#frontend-setup)
    * [Navigate to frontend folder](#navigate-to-frontend-folder)
